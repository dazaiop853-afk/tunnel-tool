...
__version__ = "1.0.0"
__source_url__ = "https://raw.githubusercontent.com/YOUR_USER/tunneltool/main/tunnel_tool.py"
__cdn_url__ = "https://cdn.jsdelivr.net/gh/YOUR_USER/tunneltool@main/tunnel_tool.py"
